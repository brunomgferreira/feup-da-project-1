#ifndef WATER_SUPPLY_ANALYSIS_SYSTEM_GET_PUMPING_STATION_STATE_H
#define WATER_SUPPLY_ANALYSIS_SYSTEM_GET_PUMPING_STATION_STATE_H
...
#endif //WATER_SUPPLY_ANALYSIS_SYSTEM_GET_PUMPING_STATION_STATE_H
