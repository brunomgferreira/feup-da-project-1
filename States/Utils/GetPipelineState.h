#ifndef WATER_SUPPLY_ANALYSIS_SYSTEM_GETPIPELINESTATE_H
#define WATER_SUPPLY_ANALYSIS_SYSTEM_GETPIPELINESTATE_H
...
#endif //WATER_SUPPLY_ANALYSIS_SYSTEM_GETPIPELINESTATE_H
