#ifndef WATER_SUPPLY_ANALYSIS_SYSTEM_PIPELINE_IMPACT_MENU_STATE_H
#define WATER_SUPPLY_ANALYSIS_SYSTEM_PIPELINE_IMPACT_MENU_STATE_H
...
public:
    ...
    /**
    * @brief Default constructor for PipelineImpactMenuState.
    *
    * @details This constructor initializes an instance of the PipelineImpactMenuState class. It doesn't require any parameters,
    ...
    */
    PipelineImpactMenuState();

    /**
    * @brief Displays the Pipeline Impact Menu options.
    *
    * @details This method prints the Pipeline Impact Menu options to the console, allowing users to choose from different
    ...
    */
    ...
    /**
    * @brief Handles user input for the Pipeline Impact Menu.
    *
    * @details This method prompts the user to input a single character representing their choice in the Pipeline Impact Menu.
...
#endif //WATER_SUPPLY_ANALYSIS_SYSTEM_PIPELINE_IMPACT_MENU_STATE_H
